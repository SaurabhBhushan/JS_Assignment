...
class Enemies {
  ...
  constructor (scene, level) {
    ...
    var objetivo1 = new Physijs.BoxMesh (new THREE.SphereGeometry (5, 32, 32), this.mat1, 1);
   ...
   var objetivo2 = new Physijs.BoxMesh (new THREE.SphereGeometry (5, 32, 32), this.mat2, 1);
    ...
    var objetivo3 = new Physijs.BoxMesh (new THREE.SphereGeometry (5, 32, 32), this.mat3, 1);
    ...
    var objetivo4 = new Physijs.BoxMesh (new THREE.SphereGeometry (5, 32, 32), this.mat4, 1);
  ...
  animate() {
    for (var i = 0; i < this.enemies.length; ++i) {
      if (this.enemies[i].position.x >= 100 && this.direction[i] == "left") {
        this.enemies[i].applyCentralImpulse(new THREE.Vector3(-this.force,this.force,0));
